...
part 'TranslatorLanguage.g.dart';
...
class TranslatorLanguage {
  ...
  TranslatorLanguage(this.id, this.languageCode, this.name, this.imageLocalStoragePath);

  factory TranslatorLanguage.fromJson(Map<String, dynamic> json) => _$TranslatorLanguageFromJson(json);
